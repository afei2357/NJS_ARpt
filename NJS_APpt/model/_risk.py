...
def predict_risk(data_fi,outdir):
    ...
    print(f'"{rscript_path}" {r_dir}/Risk.R --newdata={data_fi} --model={r_dir}/plsmodel.rds --variables={r_dir}/varnames.rds --rawdata={r_dir}/njs1_2.rds --outdir={outdir}')
    ...
    subprocess.call(f'"{rscript_path}" {r_dir}/Risk.R --newdata={data_fi} --model={r_dir}/plsmodel.rds --variables={r_dir}/varnames.rds --rawdata={r_dir}/njs1_2.rds --outdir={outdir}',shell=True)
